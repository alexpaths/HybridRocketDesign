function progressbar(fractiondone, label, position)
% Description:
%   progressbar(fractiondone,label,position) provides an indication of the progress of
...
%
% Modified:  Alexander Athougies - Added labeling functionality
%
%  label => string for labeling which progressbar is which (ie. '<function
%  name>')
%
% Features:
...
%   label specifies a tag or indicator that allows personalization of the
% progressbar for the individual codes.  Thereby giving the user an update
% on which function is running or allowing the user to put in custom
% messages.  The label can change every time the function is called
% therefore adding the capability of knowing which part of the code is
% being run.
...
% 2009-Jan-12   Added Label in Title Bar Capability - Alexander Athougies
